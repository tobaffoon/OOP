...
public class TreeGen<E> implements Iterable<E> {
     ...
     * root, tree becomes empty if no children If this element isn't root, its children are assigned
     * to element's parent
     *
    ...
    /**
     * Check if this and o are equal Compare nodes' value at same index. Index does not represent
     * position
     */
